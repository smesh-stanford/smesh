...
def on_receive(packet, interface):
    ...
    log_file_prefix = f'./data/network_tests/{nodeid}'
    ...
    try:
        ...
        if packet['decoded']['portnum'] == 'TELEMETRY_APP':
            ...
            if 'environmentMetrics' in telemetry_data:
                ...
                log_to_csv_from_preset(f'{log_file_prefix}_bme688.csv', str(datetime.now()), 
                ...
                log_to_csv_from_preset(f'{log_file_prefix}_pmsa003i.csv', str(datetime.now()),
                ...
                log_to_csv_from_preset(f'{log_file_prefix}_ina260.csv', str(datetime.now()),
                ...
                log_to_csv_from_preset(f'{log_file_prefix}_device_metrics.csv', str(datetime.now()),
