...
sudo source /boot/firmware/ini_wifi.sh >> /boot/firstrun_ini_wifi.log 2>&1
sudo source /boot/firmware/ini_overlays.sh >> /boot/firstrun_ini_overlays.log 2>&1
sudo source /boot/firmware/ini_swap.sh >> /boot/firstrun_ini_swap.log 2>&1
sudo source /boot/firmware/ini_swinstall.sh >> /boot/firstrun_ini_swinstall.log 2>&1
sudo source /boot/firmware/ini_cron.sh >> /boot/firstrun_ini_cron.log 2>&1
sudo source /boot/firmware/ini_hotspot.sh >> /boot/firstrun_ini_hotspot.log 2>&1
